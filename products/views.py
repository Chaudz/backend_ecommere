...
class CategoryDetailAPIView(views.APIView):
    ...
    def get(self, request, id_slug, format=None):
        try:
            ...
            return custom_response('Get category failed!', 'Error', "Category not found!", 404)
    ...
    def put(self, request, id_slug):
        try:
            ...
            return custom_response('Update category failed', 'Error', "Category not found!", 404)
    ...
    def delete(self, request, id_slug):
        try:
            ...
            return custom_response('Delete category failed!', 'Error', "Category not found!", 404)
...
class ProductDetailAPIView(views.APIView):
    ...
    def get(self, request, id_slug, format=None):
        try:
            ...
            return custom_response('Get product failed!', 'Error', "Product not found!", 404)
    ...
    def put(self, request, id_slug):
        try:
            ...
            return custom_response('Update product failed', 'Error', "Product not found!", 404)
    ...
    def delete(self, request, id_slug):
        try:
            ...
            return custom_response('Delete product failed!', 'Error', "Product not found!", 404)
...
class ProductImageDetailAPIView(views.APIView):
    ...
    def get(self, request, product_id_slug, id_slug, format=None):
        try:
            ...
            return custom_response('Get product image failed!', 'Error', "Product image not found!", 404)
    ...
    def put(self, request, product_id_slug, id_slug):
        try:
            ...
            return custom_response('Update product image failed', 'Error', "Product image not found!", 404)
    ...
    def delete(self, request, product_id_slug, id_slug):
        try:
            ...
            return custom_response('Delete product image failed!', 'Error', "Product image not found!", 404)
...
class ProductCommentDetailAPIView(views.APIView):
    def get_object(self, id_slug):
        try:
            ...
            raise Http404("Product comment not found")
    ...
    def get(self, request, product_id_slug, id_slug, format=None):
        try:
            ...
            return custom_response('Get product comment failed!', 'Error', "Product comment not found!", 404)
    ...
    def put(self, request, product_id_slug, id_slug):
        try:
            ...
            return custom_response('Update product comment failed', 'Error', "Product comment not found!", 404)
    ...
    def delete(self, request, product_id_slug, id_slug):
        try:
            ...
            return custom_response('Delete product comment failed!', 'Error', "Product comment not found!", 404)
